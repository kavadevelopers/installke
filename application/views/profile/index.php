<div class="page-content">
    ...
    <div class="content mb-2 mt-1">
        <div class="row mb-0">
            <div class="col-6 pr-1">
                <a href="<?= base_url('profile/deposit') ?>" style="width: 100%;" class="btn btn-full color-white btn-m gradient-highlight rounded-s font-13 font-600">Deposit</a>
            </div>
            <div class="col-6 pl-1">
                <a href="<?= base_url('profile/withdraw') ?>" style="width: 100%;" class="btn btn-full color-white btn-m gradient-highlight rounded-s font-13 font-600">Withdraw</a>
            </div>
        </div>
    </div>
    ...
    <div class="card card-style">
        <div class="content mt-0 mb-0">
            <div class="list-bgroup list-custom-small list-icon-0">
                <a href="<?= base_url('profile/withdraw_records') ?>" class="d-block-k">
                    <i class="fa fa-credit-card rounded-sm bg-blue-dark"></i><span>Withdrawal Record</span><i class="fa fa-angle-right"></i></a></i>
                </a>
                <a href="<?= base_url('profile/deposit_records') ?>" class="d-block-k">
                    <i class="fa fa-money rounded-sm bg-pink-dark"></i><span>Deposit Record</span><i class="fa fa-angle-right"></i></a></i>
                </a>
