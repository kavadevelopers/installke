...
<html lang="en">
    ...
    <head>
        ...
        <title>Payment Failed | <?= get_setting()['name'] ?></title>
        ...
        <div id="page">
            <div class="page-content">
                <div class="card card-style p-4 text-center" style="margin-top: 150px;">
                    <p class="font-600 color-highlight mb-0"><a href="#" class="icon icon-m mt-1 rounded-m gradient-red"><i class="fa fa-times"></i></a></p>
                    <h1>Payment Failed </h1>
                    <p>
                        Transaction Failed. please try again later
                    </p>
                    <a href="<?= base_url('welcome') ?>" class="btn btn-m btn-center-m font-700 gradient-highlight rounded-s mb-3">OK</a>
                </div>
            </div>
        </div>
