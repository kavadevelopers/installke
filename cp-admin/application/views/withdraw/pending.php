                            ...
                            <?php foreach ($list as $key => $value) { ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= base_url('withdraw/approved/').$value['id'] ?>" class="btn btn-success btn-mini">
                                            Approve
                                        </a>
                                        <a href="<?= base_url('withdraw/rejected/').$value['id'] ?>/pending" class="btn btn-danger btn-mini" onclick="return confirm('Are you sure?')">
                                            Reject
                                        </a>
                                    </td>
                                </tr>
